...
import com.ibetter.www.adskitedigi.adskitedigi.display_local_media_folder.RenderRSSFeeds;
...
public class MultiRegionSupport
{
    ...
    private void startReadExcelFile(RecyclerView excelLayout,String path)
    {
        ...
        ReadExcelFile readExcelFile = new ReadExcelFile(path,context,((DisplayLocalFolderAds)activity),new Handler(),excelLayout);
