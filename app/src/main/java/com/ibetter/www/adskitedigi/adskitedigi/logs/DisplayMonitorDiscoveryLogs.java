...
public class DisplayMonitorDiscoveryLogs extends AsyncTask<String, Void, Void>
{

    private Context context;
    private String  DEBUG_TAG="SS Debug: ";

    public DisplayMonitorDiscoveryLogs(Context context) {
    ...
    private  void  saveLog(String log)
    {
        ...
        filePath=getLogDirectory()+"/MonitorDiscoveryLogs.txt";
    ...
    public Uri saveLogTextToFile( String data, Context context) {
        File dir;
        String state = Environment.getExternalStorageState();
        ...
        final File file = new File(dir, "MonitorDiscoveryLogs.txt");
